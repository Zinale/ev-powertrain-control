###########################################################################
## Makefile generated for component 'SLC1'. 
## 
## Makefile     : SLC1.mk
## Generated on : Wed Apr 22 14:46:49 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SLC1.exe
...
START_DIR                 = C:/Users/zinga/Documents/.UNIVPM/PolimarcheRacingTeam/EV-POWERTRAIN-CONTROL/ev-powertrain-control/Controls/StraightLineControl
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = SLC1_comp.rsp
CMD_FILE                  = SLC1.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SLC1.exe
...
DEFINES_STANDARD = -DMODEL=SLC1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/SLC1_ert_rtw/SLC1.c $(START_DIR)/SLC1_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/SLC1_ert_rtw/ert_main.c
...
OBJS = SLC1.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/SLC1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/SLC1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/SLC1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/SLC1_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/SLC1_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SLC1.obj : $(START_DIR)/SLC1_ert_rtw/SLC1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/SLC1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/SLC1_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
