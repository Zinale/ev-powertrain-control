%% Minimize Lap Time Considering Regeneration Using Optimization, Kyalami
% 
% This example shows how to minimize lap times using optimization
% algorithms using the Kyalami Grand Prix Circuit. The cost
...
sm_car_optim_traj_vx_regen(mdl,'CRG_Kyalami',25);
sm_car_optim_traj_vx_regen_plot(OptRes_CRG_Kyalami)
