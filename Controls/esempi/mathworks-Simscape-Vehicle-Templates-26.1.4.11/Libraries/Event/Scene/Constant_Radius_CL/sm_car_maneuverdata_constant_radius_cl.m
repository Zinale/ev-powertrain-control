function maneuver_data = sm_car_maneuverdata_constant_radius_cl

maneuver_type = 'Constant_Radius_CL';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'Constant_Radius_CL_trajectory_default.mat';
