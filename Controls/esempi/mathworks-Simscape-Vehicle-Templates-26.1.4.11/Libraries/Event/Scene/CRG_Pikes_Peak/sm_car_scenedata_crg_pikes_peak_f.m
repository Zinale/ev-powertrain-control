function scene_data = sm_car_scenedata_crg_pikes_peak_f
%% Scene parameters
...
scene_data.Name               = 'CRG_Pikes_Peak_F';
scene_data.CRGfile            = 'CRG_Pikes_Peak_f.crg';
scene_data.Geometry.filename  = 'CRG_Pikes_Peak_f.stl';
...
scene_data.Geometry.centerline.filename  = 'CRG_Pikes_Peak_f_centerline.stl';
