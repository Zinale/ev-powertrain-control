function maneuver_data = sm_car_maneuverdata_double_lane_change
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'Double_Lane_Change_trajectory_default.mat';
    ...
    mdata.(Instance).xMax.Value            = 260; % m
