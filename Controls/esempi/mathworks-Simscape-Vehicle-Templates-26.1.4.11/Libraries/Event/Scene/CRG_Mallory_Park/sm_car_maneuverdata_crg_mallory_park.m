function maneuver_data = sm_car_maneuverdata_crg_mallory_park

maneuver_type = 'CRG_Mallory_Park';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Mallory_Park_trajectory_default.mat';
