function maneuver_data = sm_car_maneuverdata_crg_mallory_park_f

maneuver_type = 'CRG_Mallory_Park_F';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Mallory_Park_f_trajectory_default.mat';
