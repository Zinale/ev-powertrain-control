function maneuver_data = sm_car_maneuverdata_crg_suzuka_f

maneuver_type = 'CRG_Suzuka_F';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Suzuka_f_trajectory_default.mat';
