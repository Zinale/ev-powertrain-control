function maneuver_data = sm_car_maneuverdata_crg_suzuka

maneuver_type = 'CRG_Suzuka';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Suzuka_trajectory_default.mat';
