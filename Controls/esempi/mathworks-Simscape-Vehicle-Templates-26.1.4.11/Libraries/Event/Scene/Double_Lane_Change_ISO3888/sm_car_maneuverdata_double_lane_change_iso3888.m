function maneuver_data = sm_car_maneuverdata_double_lane_change_iso3888
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'Double_Lane_Change_ISO3888_trajectory_default.mat';
