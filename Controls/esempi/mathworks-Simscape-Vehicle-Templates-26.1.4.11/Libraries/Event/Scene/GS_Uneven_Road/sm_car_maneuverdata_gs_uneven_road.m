function maneuver_data = sm_car_maneuverdata_gs_uneven_road

maneuver_type = 'GS_Uneven_Road';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'GS_Uneven_Potholes_Constant_Speed_trajectory.mat';
