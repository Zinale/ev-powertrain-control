function scene_data = sm_car_scenedata_crg_custom
%% Scene parameters
...
scene_data.Name               = 'CRG_Custom';
scene_data.CRGfile            = 'CRG_Custom.crg';
scene_data.Geometry.filename  = 'CRG_Custom.stl';
...
scene_data.Geometry.centerline.filename  = 'CRG_Custom_centerline.stl';
