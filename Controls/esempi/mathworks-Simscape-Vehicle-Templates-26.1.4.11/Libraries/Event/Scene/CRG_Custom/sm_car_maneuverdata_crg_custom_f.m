function maneuver_data = sm_car_maneuverdata_crg_custom_f

maneuver_type = 'CRG_Custom_F';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Custom_f_trajectory_default.mat';
