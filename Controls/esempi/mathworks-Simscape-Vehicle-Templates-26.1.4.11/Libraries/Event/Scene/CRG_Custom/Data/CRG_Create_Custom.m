function traj_coeff = CRG_Create_Custom
...
if(nargout == 0)
    ...
    sm_car_centerline_to_crg('CRG Custom',road_opts)
end
...
if(nargout == 0)
    ...
    sm_car_trajectory_calc('CRG_Custom',traj_coeff)
    
    % Create driver trajectory for road with elevation
    sm_car_trajectory_calc('CRG_Custom_f',traj_coeff)
end