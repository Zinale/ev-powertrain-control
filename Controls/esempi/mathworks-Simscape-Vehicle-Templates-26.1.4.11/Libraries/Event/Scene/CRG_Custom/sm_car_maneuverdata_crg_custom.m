function maneuver_data = sm_car_maneuverdata_crg_custom

maneuver_type = 'CRG_Custom';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Custom_trajectory_default.mat';
