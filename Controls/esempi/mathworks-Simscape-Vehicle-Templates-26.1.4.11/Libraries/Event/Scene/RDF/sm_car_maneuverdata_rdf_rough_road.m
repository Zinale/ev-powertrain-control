function maneuver_data = sm_car_maneuverdata_rdf_rough_road

maneuver_type = 'RDF_Rough_Road';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'Straight_Constant_Speed_trajectory_6_30.mat';
