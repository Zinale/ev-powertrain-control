function maneuver_data = sm_car_maneuverdata_mcity
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'MCity_trajectory_default.mat';
    ...
    mdata.(Instance).xPreview.x.Value      = [5 2 4]; % m
