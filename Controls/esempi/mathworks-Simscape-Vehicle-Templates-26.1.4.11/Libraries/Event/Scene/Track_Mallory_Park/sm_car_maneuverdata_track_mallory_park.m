...
Instance_List = {...
    ...
    'CCW_Sedan_Hamba','CCW_Sedan_HambaLG','CCW_SUV_Landy','CCW_Bus_Makhulu','CCW_Truck_Amandla','CCW_Truck_Rhuqa','CCW_FSAE_Achilles'};
...
mdata.CCW_SUV_Landy.Trajectory_LoadFile.Value     = 'Mallory_Park_trajectory_CCW.mat';
