function maneuver_data = sm_car_maneuverdata_crg_nurburgring_n

maneuver_type = 'CRG_Nurburgring_N';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Nurburgring_N_trajectory_default.mat';
