function maneuver_data = sm_car_maneuverdata_crg_nurburgring_n_f

maneuver_type = 'CRG_Nurburgring_N_F';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Nurburgring_N_f_trajectory_default.mat';
