function scene_data = sm_car_scenedata_crg_nurburgring_n_f
%% Scene parameters
...
scene_data.Name               = 'CRG_Nurburgring_N_F';
scene_data.CRGfile            = 'CRG_Nurburgring_N_f.crg';
scene_data.Geometry.filename  = 'CRG_Nurburgring_N_f.stl';
...
scene_data.Geometry.w     = 18;          % m

scene_data.Geometry.centerline.filename  = 'CRG_Nurburgring_N_f_centerline.stl';
...
scene_data.Geometry.finish_line.post.separation = 18;         % m
