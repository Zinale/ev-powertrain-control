function scene_data = sm_car_scenedata_crg_kyalami
%% Scene parameters
...
scene_data.Name               = 'CRG_Kyalami';
scene_data.CRGfile            = 'CRG_Kyalami.crg';
scene_data.Geometry.filename  = 'CRG_Kyalami.stl';
...
scene_data.Geometry.centerline.filename  = 'CRG_Kyalami_centerline.stl';
