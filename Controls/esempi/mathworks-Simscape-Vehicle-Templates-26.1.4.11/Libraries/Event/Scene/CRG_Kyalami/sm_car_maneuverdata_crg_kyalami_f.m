function maneuver_data = sm_car_maneuverdata_crg_kyalami_f

maneuver_type = 'CRG_Kyalami_F';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Kyalami_f_trajectory_default.mat';
