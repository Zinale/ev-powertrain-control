function maneuver_data = sm_car_maneuverdata_crg_kyalami

maneuver_type = 'CRG_Kyalami';
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'CRG_Kyalami_trajectory_default.mat';
