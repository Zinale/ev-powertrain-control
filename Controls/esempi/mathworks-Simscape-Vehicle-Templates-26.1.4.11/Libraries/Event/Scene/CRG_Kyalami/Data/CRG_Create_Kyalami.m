function traj_coeff = CRG_Create_Kyalami
...
traj_coeff.vmax           = 28.50;   % Max speed, m/s
traj_coeff.vmin           = 6.3;    % Min speed, m/s
traj_coeff.decimation     = 8;      % Decimation for interpolation
if(nargout == 0)
    % Create driver trajectory for road with elevation
    sm_car_trajectory_calc('CRG_Kyalami',traj_coeff)
    
    % Create driver trajectory for road with elevation
    sm_car_trajectory_calc('CRG_Kyalami_f',traj_coeff)
end