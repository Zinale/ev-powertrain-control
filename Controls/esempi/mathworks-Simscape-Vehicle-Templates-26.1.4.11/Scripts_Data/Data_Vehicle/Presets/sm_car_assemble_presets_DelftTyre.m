...
Tire_Set  = {'MFEval_Generic_235_50R24','Delft_Generic_235_50R24'};
...
%% Custom Configuration 13: Sedan Hamba Delft
veh_ind = veh_ind+1;
Vehicle = Vehicle_002;
VDatabase = evalin('base','VDatabase');
Vehicle.Chassis.Body = VDatabase.Body.Sedan_Hamba;
...
Vehicle.Chassis.TireF = VDatabase.Tire.Delft_213_40R21;
Vehicle.Chassis.TireF.TireBody = VDatabase.TireBody.CAD_213_40R21;
Vehicle.Chassis.TireR = VDatabase.Tire.Delft_213_40R21;
Vehicle.Chassis.TireR.TireBody = VDatabase.TireBody.CAD_213_40R21;
...
% Assemble configuration description in string
Vehicle.config = 'Hamba_dwb_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 13: Sedan Hamba Delft, Linear
veh_ind = veh_ind+1;
Vehicle = Vehicle_002;
VDatabase = evalin('base','VDatabase');
Vehicle.Chassis.Body = VDatabase.Body.Sedan_Hamba;
...
% Assemble configuration description in string
Vehicle.config = 'Hamba_dwb_Delft_lintra_fCVpCVr1D';
...
%% Custom Configuration 16: Bus Makhulu 6 tires Delft
veh_ind = veh_ind+1;
Vehicle = Vehicle_002;
VDatabase = evalin('base','VDatabase');
Vehicle.Chassis.Body = VDatabase.Body.Bus_Makhulu;
...
Vehicle.Chassis.TireF = VDatabase.Tire.Delft_270_70R22;
Vehicle.Chassis.TireF.TireBody = VDatabase.TireBody.CAD_270_70R22;
Vehicle.Chassis.TireR = VDatabase.Tire.Tire2x_Bus_Makhulu;
Vehicle.Chassis.TireR.TireOuter = VDatabase.Tire.Delft_270_70R22;
Vehicle.Chassis.TireR.TireInner = VDatabase.Tire.Delft_270_70R22;
Vehicle.Chassis.TireR.TireOuter.TireBody = VDatabase.TireBody.CAD_270_70R22_2x;
Vehicle.Chassis.TireR.TireInner.TireBody = VDatabase.TireBody.None;
...
% Assemble configuration description in string
Vehicle.config = 'Makhulu_dwb_Delft2x_steady_fCVpCVr1D';
...
%% Custom Configuration 17: Bus Makhulu 4 tires Delft
veh_ind = veh_ind+1;
Vehicle = Vehicle_002;
VDatabase = evalin('base','VDatabase');
Vehicle.Chassis.Body = VDatabase.Body.Bus_Makhulu;
...
Vehicle.Chassis.TireF = VDatabase.Tire.Delft_270_70R22;
Vehicle.Chassis.TireF.TireBody = VDatabase.TireBody.CAD_270_70R22;
Vehicle.Chassis.TireR = VDatabase.Tire.Delft_270_70R22;
Vehicle.Chassis.TireR.TireBody = VDatabase.TireBody.CAD_270_70R22;
...
% Assemble configuration description in string
Vehicle.config = 'Makhulu_dwb_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 29: Hamba Live Axle, Delft
veh_ind = veh_ind+1;
Vehicle = Vehicle_140;
Vehicle.Chassis.SuspR = VDatabase.Susp.LiveAxle_Sedan_Hamba_r;
Vehicle.Chassis.Spring.Rear = VDatabase.Spring.Linear_Sedan_Hamba_LiveAxle_r;
...
% Assemble configuration description in string
Vehicle.config = 'Hamba_LiveAxle_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 31: Hamba Electric2Motor, Delft
veh_ind = veh_ind+1;
Vehicle = Vehicle_140;
Vehicle.Powertrain.Power = VDatabase.Power.Electric2Motor_default;
% Assemble configuration description in string
Vehicle.config = 'Hamba_E2sha_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 33: Hamba 3 power shaft, Delft
veh_ind = veh_ind+1;
Vehicle = Vehicle_140;
Vehicle.Powertrain.Power = VDatabase.Power.Electric3Motor_default;
Vehicle = sm_car_vehcfg_setDrv(Vehicle,'A2_D1S2_CVpCV_1D_HL');
% Assemble configuration description in string
Vehicle.config = 'Hamba_E3sha_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 35: Hamba 15DOF, Delft
veh_ind = veh_ind+1;
Vehicle = Vehicle_140;
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','front');
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','rear');
...
% Assemble configuration description in string
Vehicle.config = 'Hamba_15DOF_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 37: Hamba 15DOF, Delft, 2 Motor Cooling
veh_ind = veh_ind+1;
Vehicle = Vehicle_140;
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','front');
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','rear');
...
% Assemble configuration description in string
Vehicle.config = 'Hamba_15DOF2MotC_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 37: Hamba 15DOF, Delft, 3Motor Cooling
veh_ind = veh_ind+1;
Vehicle = Vehicle_140;
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','front');
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','rear');
...
% Assemble configuration description in string
Vehicle.config = 'Hamba_15DOF3MotC_Delft_steady_fCVpCVr1D';
...
%% Custom Configuration 38: Hamba 15DOF, Delft, 1D
veh_ind = veh_ind+1;
Vehicle = Vehicle_140;
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','front');
Vehicle = sm_car_vehcfg_setSusp(Vehicle,'15DOF_SH','rear');
...
% Assemble configuration description in string
Vehicle.config = 'Hamba_15DOF_Delft_steady_A2_D1D2_1D_1D_HL';
...
vehcfg_set = {
    ...
    'Susp',         '15DOF_TrElu',     'front';
    'Steer',        'None_default',    'front';...
    'Tire',         'Delft_Generic_213_40R21',      'front';
    'TireDyn',      'steady',  'front';
    'Driveline',    'Axle1_None',       ''};

Trailer_03 = sm_car_vehcfg_assemble_vehicle(vehcfg_set);
Trailer_03.config = 'Elula_Delft';

save Trailer_03 Trailer_03

%% Trailer Thwala Delft
vehcfg_set = {
    'Aero',         'Trailer_Thwala',      '';...
    'Body',         'Trailer_Thwala',      '';...
    'BodyGeometry', 'CAD_Trailer_Thwala',      '';...
    ...
    'Susp',         '15DOF_TrThw',     'front';
    'Steer',        'None_default',    'front';...
    'Tire',         'Delft_CAD_145_70R13',      'front';
    'TireDyn',      'steady',  'front';
    'Driveline',    'Axle1_None',       ''};

Trailer_04 = sm_car_vehcfg_assemble_vehicle(vehcfg_set);
Trailer_04.config = 'Thwala_Delft';
