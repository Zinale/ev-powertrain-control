...
#define TORQUE_SETPOINT_MAX         1000U   /**< Maximum setpoint = 205% Mn */
#define TORQUE_LIMIT_POS            1000U   /**< Positive limit accelerating */
#define TORQUE_LIMIT_NEG           (-1000)  /**< Negative limit (regen braking) */
